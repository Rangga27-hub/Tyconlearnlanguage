...
const mandarinLessons = [
  ...
  makeLesson({ id: "zh-hans-beginner-08-help", language: "zh-Hans", order: 8, title: "Simple help", objective: "Ask for help politely.", words: [{ id: "zh-help", term: "请", translation: "please", pronunciation: "qǐng" }, { id: "zh-yes", term: "是", translation: "yes", pronunciation: "shì" }, { id: "zh-no", term: "不", translation: "no / not", pronunciation: "bù" }], phrase: { target: "请帮帮我。", translation: "Please help me.", pronunciation: "qǐng bāngbang wǒ." }, orderTokens: ["请", "帮帮", "我。"], distractors: ["wait", "stop", "welcome"] }),
] as const;
