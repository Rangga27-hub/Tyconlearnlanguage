...
import { grammarPractices, moduleBListeningPage23, moduleBReadingPage20, moduleCListeningPage38, moduleCReadingPage34, moduleDListeningPage46, moduleDListeningPage52, moduleDReadingPage49, moduleEListeningPage60, moduleEReadingPage65, moduleFListeningPage76, moduleFReadingPage72 } from "@/data/ielts-module-expansion";
...
export function IeltsJourney() {
  ...
  const [selectedListening, setSelectedListening] = useState<"A" | "B" | "C" | "D1" | "D2" | "E" | "F">("A");
  ...
  const [selectedGrammar, setSelectedGrammar] = useState<"A" | "B" | "C" | "D" | "E" | "F">("A");
  ...
  const [selectedReading, setSelectedReading] = useState<"B" | "C" | "D" | "E" | "F">("B");
  ...
  const activeReading = selectedReading === "C" ? moduleCReadingPage34 : selectedReading === "D" ? moduleDReadingPage49 : selectedReading === "E" ? moduleEReadingPage65 : selectedReading === "F" ? moduleFReadingPage72 : moduleBReadingPage20;
  ...
  const moduleThemes: Record<(typeof ieltsModules)[number], { title: string; icon: string; unlocked: boolean; accent: string }> = {
    ...
    G: { title: "Communication", icon: "📡", unlocked: false, accent: "mint" },
    H: { title: "Future", icon: "🚀", unlocked: false, accent: "sun" },
  ...
  function openListening(module: "A" | "B" | "C" | "D1" | "D2" | "E" | "F") {
    const practice = module === "B" ? moduleBListeningPage23 : module === "C" ? moduleCListeningPage38 : module === "D1" ? moduleDListeningPage46 : module === "D2" ? moduleDListeningPage52 : module === "E" ? moduleEListeningPage60 : module === "F" ? moduleFListeningPage76 : ieltsListeningModuleAPage14;
  ...
  function openGrammar(module: "A" | "B" | "C" | "D" | "E" | "F") {
  ...
  function openReadingB(module: "B" | "C" | "D" | "E" | "F" = "B") {
    const practice = module === "C" ? moduleCReadingPage34 : module === "D" ? moduleDReadingPage49 : module === "E" ? moduleEReadingPage65 : module === "F" ? moduleFReadingPage72 : moduleBReadingPage20;
