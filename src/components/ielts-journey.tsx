...
export function IeltsJourney() {
  ...
  const [selectedListening, setSelectedListening] = useState<"A" | "B" | "C" | "D1" | "D2" | "E" | "F" | "G1" | "G2" | "H" | "I" | "J">("A");
  ...
  const [selectedGrammar, setSelectedGrammar] = useState<"A" | "B" | "C" | "D" | "E" | "F" | "G" | "H" | "I" | "J">("A");
  ...
  const [selectedReading, setSelectedReading] = useState<"B" | "C" | "D" | "E" | "F" | "G" | "H" | "I" | "J">("B");
  ...
  const listeningPractice = selectedListening === "B" ? moduleBListeningPage23 : selectedListening === "C" ? moduleCListeningPage38 : selectedListening === "D1" ? moduleDListeningPage46 : selectedListening === "D2" ? moduleDListeningPage52 : selectedListening === "E" ? moduleEListeningPage60 : selectedListening === "F" ? moduleFListeningPage76 : selectedListening === "G1" ? moduleGListeningPage87 : selectedListening === "G2" ? moduleGListeningPage94 : selectedListening === "H" ? moduleHListeningPage99 : selectedListening === "I" ? moduleIListeningPage117 : selectedListening === "J" ? moduleJListeningPage124 : moduleAListeningPractice;
  ...
  const activeReading = selectedReading === "C" ? moduleCReadingPage34 : selectedReading === "D" ? moduleDReadingPage49 : selectedReading === "E" ? moduleEReadingPage65 : selectedReading === "F" ? moduleFReadingPage72 : selectedReading === "G" ? moduleGReadingPage88 : selectedReading === "H" ? moduleHReadingPage103 : selectedReading === "I" ? moduleIReadingPage112 : selectedReading === "J" ? moduleJReadingPage126 : moduleBReadingPage20;
  ...
  const moduleThemes: Record<(typeof ieltsModules)[number], { title: string; icon: string; unlocked: boolean; accent: string }> = {
    ...
    I: { title: "Tourism", icon: "🚌", unlocked: true, accent: "berry" },
    J: { title: "Images", icon: "🎨", unlocked: true, accent: "mint" },
  };
  ...
  function openListening(module: "A" | "B" | "C" | "D1" | "D2" | "E" | "F" | "G1" | "G2" | "H" | "I" | "J") {
    const practice = module === "B" ? moduleBListeningPage23 : module === "C" ? moduleCListeningPage38 : module === "D1" ? moduleDListeningPage46 : module === "D2" ? moduleDListeningPage52 : module === "E" ? moduleEListeningPage60 : module === "F" ? moduleFListeningPage76 : module === "G1" ? moduleGListeningPage87 : module === "G2" ? moduleGListeningPage94 : module === "H" ? moduleHListeningPage99 : module === "I" ? moduleIListeningPage117 : module === "J" ? moduleJListeningPage124 : ieltsListeningModuleAPage14;
  ...
  function openGrammar(module: "A" | "B" | "C" | "D" | "E" | "F" | "G" | "H" | "I" | "J") {
  ...
  function openReadingB(module: "B" | "C" | "D" | "E" | "F" | "G" | "H" | "I" | "J" = "B") {
    const practice = module === "C" ? moduleCReadingPage34 : module === "D" ? moduleDReadingPage49 : module === "E" ? moduleEReadingPage65 : module === "F" ? moduleFReadingPage72 : module === "G" ? moduleGReadingPage88 : module === "H" ? moduleHReadingPage103 : module === "I" ? moduleIReadingPage112 : module === "J" ? moduleJReadingPage126 : moduleBReadingPage20;
