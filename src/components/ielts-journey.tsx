...
import { grammarPractices, moduleBListeningPage23, moduleBReadingPage20, moduleCListeningPage38, moduleCReadingPage34, moduleDListeningPage46, moduleDListeningPage52, moduleDReadingPage49 } from "@/data/ielts-module-expansion";
...
export function IeltsJourney() {
  ...
  const [selectedListening, setSelectedListening] = useState<"A" | "B" | "C" | "D1" | "D2">("A");
  ...
  const [selectedGrammar, setSelectedGrammar] = useState<"A" | "B" | "C" | "D">("A");
  ...
  const [selectedReading, setSelectedReading] = useState<"B" | "C" | "D">("B");
  ...
  const listeningPractice = selectedListening === "B" ? moduleBListeningPage23 : selectedListening === "C" ? moduleCListeningPage38 : selectedListening === "D1" ? moduleDListeningPage46 : selectedListening === "D2" ? moduleDListeningPage52 : moduleAListeningPractice;
  ...
  const activeReading = selectedReading === "C" ? moduleCReadingPage34 : selectedReading === "D" ? moduleDReadingPage49 : moduleBReadingPage20;
  ...
  const moduleThemes: Record<(typeof ieltsModules)[number], { title: string; icon: string; unlocked: boolean; accent: string }> = {
    ...
    E: { title: "Nature", icon: "🌋", unlocked: false, accent: "sun" },
    F: { title: "Study", icon: "💻", unlocked: false, accent: "berry" },
  ...
  function openListening(module: "A" | "B" | "C" | "D1" | "D2") {
    const practice = module === "B" ? moduleBListeningPage23 : module === "C" ? moduleCListeningPage38 : module === "D1" ? moduleDListeningPage46 : module === "D2" ? moduleDListeningPage52 : ieltsListeningModuleAPage14;
  ...
  function openGrammar(module: "A" | "B" | "C" | "D") {
  ...
  function openReadingB(module: "B" | "C" | "D" = "B") {
    const practice = module === "C" ? moduleCReadingPage34 : module === "D" ? moduleDReadingPage49 : moduleBReadingPage20;
